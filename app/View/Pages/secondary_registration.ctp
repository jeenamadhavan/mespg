                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <label for="CourseChoice4" class="control-label">Choice 4<sup class="madadatory">*</sup></label><br>
                                            <?php
                                            echo $this->Form->input('SecondaryRegister.CourseChoice4', array(
                                                'options' => $courses,
                                                'empty' => '-- select one --',
                                                'class' => 'form-control',
                                                'id' => 'CourseChoice4',
                                        ...
                                        <td>
                                            <label for="CourseChoice5" class="control-label">Choice 5<sup class="madadatory">*</sup></label><br>
                                            <?php
                                            echo $this->Form->input('SecondaryRegister.CourseChoice5', array(
                                                'options' => $courses,
                                                'empty' => '-- select one --',
                                                'class' => 'form-control',
                                                'id' => 'CourseChoice5',
...
<script>
    ...
    $('#QualifyingExam').on('change',function(e){
        var id=$(this).val();
        ...
        $('#stream').attr('rel',id);
         ...
         /*if(id==4){ $.ajax({
            type: "POST",
            url: '<?php echo Router::url('/', true) . "pages/ajax_otherview"; ?>',
            data: { 'id':id  },
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo Router::url('/', true) . "pages/ajax_view"; ?>',
            data: { 'id':id  },
            success: function(response){
                $("#marktable").html(response);
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo Router::url('/', true) . "pages/getstream"; ?>',
            data: { 'id':id  },
            success: function(strJSON){
                
               var json = $.parseJSON(strJSON);
               var $el = $("#stream");
                $el.empty();$el.append($("<option ></option>")
                    .attr("value", 0).text("--select one --"));
                $.each(json, function(value,key) {
                    $el.append($("<option name='stream' class='form-control' empty='-- select one --' required='required' ></option>")
    ...
    $('#stream').on('change',function(){
        ...
        var board_id=$("#stream").attr('rel');
        alert(stream_id);alert(board_id);
        if(stream_id!=0){
        $('#marktable').show();
        $.ajax({
            type: "POST",
            url: '<?php echo Router::url('/', true) . "pages/getsubjects"; ?>',
            data: { 'id':stream_id  },
            success: function(strJSON){
                var json = $.parseJSON(strJSON);
                ...
                $(json).each(function(i,val){
                    $.each(val,function(k,v){ 
                       if(k=='part')    {
                            $('#part'+v+'subject').append('<option value="' + json[i].id + '">' + json[i].name + '</option>');
                           
                            $('#part'+v+'subject').attr('rel',json[i].stream_id);
                      
                        }
                       
                        if(k=='part'&&v==3)    {
                            $("#part3subject0").append('<option value="' + json[i].id + '">' + json[i].name + '</option>');
                            $("#part3subject1").append('<option value="' + json[i].id + '">' + json[i].name + '</option>');
                            $("#part3subject2").append('<option value="' + json[i].id + '">' + json[i].name + '</option>');
                            $("#part3subject3").append('<option value="' + json[i].id + '">' + json[i].name + '</option>');
                        }
                    });
                });
    ...
    var id=$(this).val();
     var sel2 = $("select#CourseChoice2");
     sel2.find("option[value="+id+"]").remove();
     var sel3 = $("select#CourseChoice3");
     sel3.find("option[value="+id+"]").remove();
     var sel4 = $("select#CourseChoice4");
     sel4.find("option[value="+id+"]").remove();
     var sel5 = $("select#CourseChoice5");
     sel5.find("option[value="+id+"]").remove();
   });
    $('#CourseChoice2').on('change',function(){
    var id=$(this).val();
     var sel2 = $("select#CourseChoice1");
     sel2.find("option[value="+id+"]").remove();
     var sel3 = $("select#CourseChoice3");
     sel3.find("option[value="+id+"]").remove();
     var sel4 = $("select#CourseChoice4");
    ...
    $('#CourseChoice4').on('change',function(){
    var id=$(this).val();
     var sel2 = $("select#CourseChoice1");
     sel2.find("option[value="+id+"]").remove();
     var sel3 = $("select#CourseChoice2");
     sel3.find("option[value="+id+"]").remove();
     var sel4 = $("select#CourseChoice3");
     sel4.find("option[value="+id+"]").remove();
     var sel5 = $("select#CourseChoice5");
     sel5.find("option[value="+id+"]").remove();
   });
   $('#CourseChoice5').on('change',function(){
    var id=$(this).val();
     var sel2 = $("select#CourseChoice1");
     sel2.find("option[value="+id+"]").remove();
     var sel3 = $("select#CourseChoice2");
