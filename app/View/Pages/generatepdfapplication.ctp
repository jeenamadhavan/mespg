...
doc.setFontSize(12);
doc.text(62, 25, 'Tel:0495 2440660 / 2440661 Fax:0495 2440468');
...
doc.text(13, 91, '9');
doc.text(20, 91, 'Qualifying Examination (+2) Passed :');
doc.line(18, 102, 200, 102); // horizontal line
doc.line(138, 94, 138, 102); // vertical line
doc.text(20, 99, '(a) Institution attended :');
doc.text(140, 99, '(b) Year of Study :');
doc.line(18, 110, 200, 110); // horizontal line
doc.line(108, 102, 108, 110); // vertical line
doc.text(20, 107, '(a) Reg: No. & Year of Passing:');
doc.text(110, 107, '(b) TC No. & Date :');
doc.line(50, 116, 170, 116); // horizontal line
...
doc.line(50, 110, 50, 140); // vertical line
doc.line(70, 110, 70, 140); // vertical line
doc.line(90, 110, 90, 140); // vertical line
doc.line(110, 116, 110, 140); // vertical line
doc.line(130, 116, 130, 140); // vertical line
doc.line(150, 116, 150, 140); // vertical line
doc.line(170, 110, 170, 140); // vertical line
doc.setFontSize(8);
doc.text(23, 117, 'Details of Marks');
doc.text(180, 117, 'Total');
doc.text(57, 114, 'Part I');
doc.text(77, 114, 'Part II');
doc.text(127, 114, 'Part III');
doc.text(23, 126, 'Grade');
doc.text(23, 132, 'Mark Scored');
doc.text(23, 138, 'Maximum Mark');
doc.setFontSize(10);
doc.line(10, 148, 200, 148); // horizontal line
doc.text(13, 145, '10');
doc.text(20, 145, 'Number of Chances taken for passing the qualifying examination : ');
doc.line(10, 156, 200, 156); // horizontal line
doc.text(13, 153, '11');
doc.text(20, 152, 'Are you eligible for claim under physically handicapped ? : ');
doc.setFontType("italic");
doc.setFontSize(7);
doc.text(20, 155, '(Attach Copies of certificate)');
doc.line(10, 164, 200, 164); // horizontal line
doc.setFontType("normal");
doc.setFontSize(10);
doc.text(13, 161, '12');
doc.text(20, 160, 'Are you eligible for grace mark for admission ? : ');
doc.setFontType("italic");
doc.setFontSize(7);
doc.text(20, 163, '(Attach Copies of certificate)');
doc.line(10, 172, 200, 172); // horizontal line
doc.setFontType("normal");
doc.setFontSize(10);
doc.text(13, 169, '13');
doc.text(20, 169, 'Have you worked in the illiteracy eradication programme ? : ');
doc.line(18, 180, 200, 180); // horizontal line
doc.text(13, 177, '14');
doc.text(20, 177, 'Details of 10th Std. Examination ? : (a) Institution attended: ');
doc.line(10, 188, 200, 188); // horizontal line
doc.text(20, 185, '(b) Year of Study: ');
doc.text(100, 185, '(b) Reg: No. & Year of Passing: ');
doc.line(98, 180, 98, 188); // vertical line
doc.line(10, 196, 200, 196); // horizontal line
doc.text(13, 194, '15');
doc.text(20, 194, 'Core course to which admission is sought: ');
doc.line(18, 204, 200, 204); // horizontal line
doc.text(20, 201, 'I Choice');
doc.text(80, 201, 'II Choice');
doc.text(140, 201, 'III Choice');
doc.line(18, 212, 200, 212); // horizontal line
doc.text(20, 217, 'IV Choice');
doc.text(80, 217, 'V Choice');
doc.setFontSize(8);
doc.text(148, 215, 'Common Choice chosein in Languages ');
doc.text(148, 218, 'other than English');
doc.setFontSize(10);
doc.text(142, 217, '16');
