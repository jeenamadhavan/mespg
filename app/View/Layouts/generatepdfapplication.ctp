...
var doc = new jsPDF();
doc.addImage(imgData, 'JPEG', 20, 7, 32, 34);
doc.setFont("times");
doc.setFontType("bold");
doc.setFontSize(22);
doc.text(60, 15, 'M E S MAMPAD COLLGE');
doc.setFontSize(13);
doc.text(65, 20, 'Mampad College P.O (MALAPPURAM)');
doc.setFontType("normal");
doc.setFontSize(12);
doc.text(80, 25, 'Tel:04931 - 200387 / 200337');

doc.setFont("helvetica");
doc.setFontSize(8);
doc.text(65, 28, 'e-mail : info@mesmampad.org     website : www.mesmampad.org');
...
doc.text(83, 53, '<?php echo $All_result[0]['Course']['frkCourseName']; ?>');
